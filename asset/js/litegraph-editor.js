...
function Editor( container_id, options )
{
	...
	html += "<div class='content'><div class='editor-area'><canvas class='graphcanvas' tabindex=10></canvas></div></div>";
	...
	graphcanvas.background_image = "../asset/img/grid.png";
	graph.onAfterExecute = function() { graphcanvas.draw(true) };

	//add stuff
	//this.addToolsButton("loadsession_button","Load","../asset/img/icon-load.png", this.onLoadButton.bind(this), ".tools-left" );
	//this.addToolsButton("savesession_button","Save","../asset/img/icon-save.png", this.onSaveButton.bind(this), ".tools-left" );
	this.addLoadCounter();
	this.addToolsButton("playnode_button","Play","../asset/img/icon-play.png", this.onPlayButton.bind(this), ".tools-right" );
	this.addToolsButton("playstepnode_button","Step","../asset/img/icon-playstep.png", this.onPlayStepButton.bind(this), ".tools-right" );
	
	if(!options.skip_livemode)
		this.addToolsButton("livemode_button","Live","../asset/img/icon-record.png", this.onLiveButton.bind(this), ".tools-right" );
	if(!options.skip_maximize)
		this.addToolsButton("maximize_button","","../asset/img/icon-maximize.png", this.onFullscreenButton.bind(this), ".tools-right" );
...
Editor.prototype.onPlayButton = function()
{
	...
	{
		button.innerHTML = "<img src='../asset/img/icon-stop.png'/> Stop";
		graph.start(); 
	}
	else
	{
		button.innerHTML = "<img src='../asset/img/icon-play.png'/> Play";
		graph.stop(); 
	}
}
...
Editor.prototype.onLiveButton = function()
{
	...
	var url = this.graphcanvas.live_mode ? "../asset/img/gauss_bg_medium.jpg" : "../asset/img/gauss_bg.jpg";
	var button = this.root.querySelector("#livemode_button");
	button.innerHTML = !is_live_mode ? "<img src='../asset/img/icon-record.png'/> Live" : "<img src='../asset/img/icon-gear.png'/> Edit" ;
}
