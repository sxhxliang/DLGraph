...
function LGraphCanvas( canvas, graph, options )
{
  ...
  //	throw ("No graph assigned");
	...
	if(options.background_image)
		this.background_image = options.background_image
...
LGraphCanvas.prototype.setCanvas = function( canvas, skip_events )
{
	...
	if(!this.bgcanvas)
	{
		...
		console.log('setCanvas', this.canvas.width,this.canvas.width)
	}
...
LGraphCanvas.prototype.processMouseDown = function(e)
{
	...
	this.canvas_mouse[0] = e.canvasX * 2;
	this.canvas_mouse[1] = e.canvasY * 2;
	this.canvas.focus();
...
LGraphCanvas.prototype.adjustRatio = function(pos)
{
	
	// var new_pos = [pos[0]*this.canvas_ratio,pos[1]*this.canvas_ratio]
	// console.log('this.canvas_ratio', new_pos)
	return pos
}
/**
...
LGraphCanvas.prototype.adjustMouseEvent = function(e)
{
	...
	if(this.canvas)
	{
		...
		// console.log(e.pageX, b.left, e.pageY, b.top, this.offset[0], this.offset[1])
	}
	else
	{
		e.localX = e.pageX;
	...
	// console.log('1-----',this.scale,	e.localX,	e.localY,e.deltaX,e.deltaY, e.canvasX,e.canvasY)
	// e.canvasX = (e.canvasX*this.scale)*2
	// e.canvasY = (e.canvasY*this.scale)*2

	// console.log('2=====',this.scale, e.canvasX,e.canvasY)
		...
		if( this.scale > 0.5 )
		{
			...
			if(title)
			{
				...
				if( node.flags.collapsed )
				{
					...
					// ctx.fillText( 'title1', 10, 10 );
					console.log(title_height + measure.width * 0.5, -title_height * 0.2)
					ctx.textAlign =  "left";
				}
				else
				{
					ctx.textAlign =  "left";
					// ctx.fillText( 'title2', 10,10 );
					ctx.fillText( title, title_height, -title_height * 0.2 );
					// console.log( title_height, -title_height * 0.2 )
				}
			}
		}
...
LGraphCanvas.prototype.resize = function(width, height)
{
	...
	// console.log(this.bgcanvas.style.width)
	// console.log(this.bgcanvas.height)
	// console.log(this.bgcanvas.style.height)
...
LGraphCanvas.onMenuAdd = function( node, options, e, prev_menu )
{
	...
	function inner_create( v, e )
	{
		...
		if(node)
		{
			...
			console.log('onMenuAdd node.pos', node.pos)
